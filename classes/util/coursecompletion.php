...
class coursecompletion {
    ...
    public function insert_or_update_user_course_progress($userid, $progress) {
        ...
        $courseprogress = $DB->get_record('myprogress_course_progress', ['courseid' => $this->course->id, 'userid' => $userid]);

        if ($courseprogress) {
            $courseprogress->progress = $progress;
            $courseprogress->timemodified = time();

            return $DB->update_record('myprogress_course_progress', $courseprogress);
        }
        ...
        return $DB->insert_record('myprogress_course_progress', $courseprogress);
    }
